...
public class PushbotSkystoneAuto extends LinearOpMode{
    ...
    public void runOpMode() throws InterruptedException {
        ...
        robot.leftMotor.setTargetPosition(getL()+220);
        robot.rightMotor.setTargetPosition(getR()+220);
        while(location == null){
    ...
    public void RunAuto(boolean blue){
        ...
        robot.leftMotor.setTargetPosition(getL() + 500);
        robot.rightMotor.setTargetPosition(getR() + 500);

        WaitTillTargetReached(50, true);
        if(blue){
            robot.leftMotor.setTargetPosition(getL() - 260 * dM);
            robot.rightMotor.setTargetPosition(getR() + 260 * dM);
        }else {
